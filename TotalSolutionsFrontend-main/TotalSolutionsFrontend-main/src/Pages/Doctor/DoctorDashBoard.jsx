...
export default function DoctorDashBoard() {
  ...
  const handleCaseHistory = () => {
    navigate("/doctordashboard/casehistory");
  };
  ...
  const handleAssignIEP = async (
    ...
    if (!therapistName || therapistName === null || therapistName === "null") {
                    ...
                    <td className="py-2 px-4 sm:py-4 sm:px-6">
                      <button
                        ...
                        onClick={() =>
                          handleAssignIEP(
                            child._id,
                            child.therapistId ? child.therapistId.name : null,
                            child.name,
                            child.centreId?.name || "",
                          )
                        }
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
              <div className="p-6">
                ...
                <p className="text-gray-600 text-center mb-6">
                  This child does not have a therapist assigned. Please contact
                  the administrator to assign a therapist before proceeding with
                  IEP management.
                </p>
                <div className="flex justify-center">
                  <button
                    onClick={closeTherapistModal}
                    className="bg-[#ab1c1c] text-white px-6 py-2 rounded-lg hover:bg-[#8e1818] transition duration-200"
                  >
                    OK
                  </button>
                </div>
