...
import hospitalogo from "../assets/totalsolutions.webp";
...
const generateIEPPDF = async (iep) => {
    try {
      ...
      const centreName = iep?.childId?.centreId?.name || "N/A";
      ...
      // Centre name - new addition
      rowY += 12;
      doc.setFont("helvetica", "bold");
      doc.text("Centre:", leftColX, rowY);
      doc.setFont("helvetica", "normal");
      doc.text(centreName, leftColX + valueIndent, rowY);
