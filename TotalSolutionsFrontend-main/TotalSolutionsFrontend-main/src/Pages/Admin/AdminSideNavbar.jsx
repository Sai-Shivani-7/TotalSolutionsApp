...
import { ChevronRight, ChevronLeft, Menu, Home, UserPlus, Calendar, Mail, Users ,User} from "lucide-react";
          ...
          <>
            ...
            <nav className="mt-6 w-64">
              <ul className="space-y-2 px-2">
                ...
                <li>
                  <Link
                    to="/admindashboard/existingusers"
                    className={`flex items-center p-3 rounded-md transition-colors ${
                      isActive("/admindashboard/existingusers")
                        ? "bg-red-50 text-[#ab1c1c] font-bold"
                        : "text-gray-700 hover:bg-gray-100"
                    }`}
                    onClick={() => isMobile && setIsOpen(false)}
