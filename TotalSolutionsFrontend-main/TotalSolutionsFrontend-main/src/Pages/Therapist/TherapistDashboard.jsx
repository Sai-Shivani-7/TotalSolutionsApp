              ...
              <div className="bg-red-50 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    ...
                    {childDetails.therapies?.length
                      ? childDetails.therapies
                          .map(t => t.therapistId.name)
                          .join(", ")
                      : "Not assigned"}
            ...
            <div className="mt-6 flex justify-end space-x-4">
              ...
              <button
                onClick={(e) => {
                  ...
                  if (childDetails.therapistId) {
                      localStorage.setItem("therapistId", childDetails.therapistId);
                  }
                  navigate("/games");
                }}
