...
import hospitalLogo from "../assets/totalsolutions.webp";
...
const generateAppointmentPDF = async (appointment) => {
  try {
    ...
    addField("Date:", formatDate(appointment.appointmentDate));
    addField("Time:", formatTime(appointment.appointmentTime));
    addField("Consultation Type:", appointment.consultationType || "Regular");
